...
const Resources = {
    ...
    GameStartBackground: new ImageSource('images/gamestartbackground.png'),
    GameEndBackground: new ImageSource('images/gameendbackground.png'),
